    ...
    <div class="row-fluid">
        <div class="users index widget span12">
            ...
            <div class="widget-body">
                ...
                <fieldset>
                    <legend><?php echo __('Add Allowed File'); ?></legend>
                    <?php
                    ...
                    echo $this->Form->input('available', array('label' => array('text' => __('Available'),'class' => 'control-label'), 'type' => 'select','options'=>array(0=>__('No'),1=>__('Yes')),'class' => 'span4','div' => array('class' => 'control-group')));
